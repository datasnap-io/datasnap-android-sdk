...
public class SuperOfEventWrapperSuper extends JSONObject {

  public SuperOfEventWrapperSuper() {
    super();
  }

  public SuperOfEventWrapperSuper(JSONObject obj) {
    super();
    merge(obj);
  }

  public SuperOfEventWrapperSuper(Object... kvs) {
    super();
